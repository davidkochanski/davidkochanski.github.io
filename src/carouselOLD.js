...
export default class MyCarousel extends Component {
    ...
    render() {
        return (
            <Carousel preventMovementUntilSwipeScrollTolerance={true} swipeScrollTolerance={10} stopOnHover={true} autoPlay={true} infiniteLoop={true} interval={5000} transitionTime={500} emulateTouch={true} showThumbs={false} selectedItem={0}>

                {/* placefox */}
                <div className="slide-image slide-image-top" style={{"background-image": "url('../img/fox-full.jpg')"}}>
                    <div className="legend">
                    <div className="legend-content">
                            <h4>March 2023 - May 2023</h4>
                            <a href="https://github.com/davidkochanski/placeholder-fox" target="_blank" rel="noreferrer"><h2>placefox.xyz <i class="fab fa-github"></i> <a href="#interactions"><i className="fas fa-arrow-up-right-from-square"></i></a></h2></a>

                            <div className="tags">
                                <div className="tag api">API</div>
                            ...
                            <p>An API for serving high quality fox images to be used as placeholder images, accessable straight from a URL.<br/>The images of various dimentions, image filters and even fox species were generated automatically using a Python script, allowing for easy expansion in the future. Pictures were generated by AI (Midjourney v5.1). </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="slide-image slide-image-top" style={{"background-image": "url('../img/pokeguesser.jpg')"}}>
                    ...
                    <div className="legend-content">
                            ...
                            <a href="https://github.com/davidkochanski/pokeguesser-react" target="_blank" rel="noreferrer"><h2>Pok&eacute;guesser <i class="fab fa-github"></i><a href="#interactions"> <i className="fas fa-arrow-up-right-from-square"></i></a></h2></a>

                            <div className="tags">
                                <div className="tag react">React.js</div>
                                <div className="tag firebase">Firebase</div>
                                <div className="tag javascript">JavaScript</div>
                                <div className="tag css">CSS</div>
                            ...
                            <div className="bar"></div>
                            <p>A Pok&eacute;mon guessing game built with React.js; my first main React project. Features different game settings, a user leaderboard with user authentication (via Firebase), sharing features and fully responsive layout!</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="slide-image" style={{"background-image": "url('../img/daveedbot.jpg')"}}>
                    <div className="legend">
                        <div className="legend-content">
                            ...
                            <a href="https://github.com/davidkochanski/DaveedBot" target="_blank" rel="noreferrer"><h2>DaveedBot <i className="fab fa-github"></i></h2></a>
                            <div className="tags">
                ...
                <div className="slide-image slide-image-top" style={{"background-image": "url('../img/tutor.jpg')", "background-position": "left top"}}>
                    ...
                    <div className="legend-content">
                            ...
                            <a href="#interactions"><h2 className="static-site">Mathify Tutor <i className="fas fa-arrow-up-right-from-square"></i></h2></a>
                ...
                <div className="slide-image slide-image-top" style={{"background-image": "url('../img/midnightfox.jpg')", "background-position": "left top"}}>
                    ...
                    <div className="legend-content">
                            ...
                            <a href="https://github.com/davidkochanski/midnight-fox" target="_blank" rel="noreferrer"><h2>Midnight Fox <i className="fab fa-github"></i> <a href="#interactions"><i className="fas fa-arrow-up-right-from-square"></i></a></h2></a>
                ...
                <div className="slide-image slide-image-top" style={{"background-image": "url('../img/adopt.jpg')", "background-position": "center top"}}>
                    ...
                    <div className="legend-content">
                            ...
                            <a href="#interactions"><h2 className="static-site">Adopt-a-lotl <i className="fas fa-arrow-up-right-from-square"></i></h2></a>
                ...
                <div className="slide-image" style={{"background-image": "url('../img/gallary.jpg')", "background-position": "center top"}}>
                    ...
                    <div className="legend-content">
                            <h4>November 2021</h4>
                            <a href="#interactions"><h2 className="static-site">Gallery of Poland <i className="fas fa-arrow-up-right-from-square"></i></h2></a>

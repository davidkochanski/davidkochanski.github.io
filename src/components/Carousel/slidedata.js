export const slides = [
    ...
    {
        title: "Safe Campus Connect",
        date: "February 2024 (@ DeerHacks 2024)",
        imageURL: "img/slide-images/sc.jpg",
        imagePos: "top center",
        tagList: ["React.js", "MongoDB", "Auth0", "CSS"],
        background: "#00A36C",
        githubURL: "https://github.com/davidkochanski/safecampusconnect",
        content: [
            "A safety-first geolocation app for students to post their findings around campus.",
            "Account regestration and authentication handled with Auth0. Frontend build with React.js and site routing using React Router DOM."
        ],
    },
    {
        title: "RealmQuest",
    ...
    {
        title: "When2Meet Improved",
        date: "April 2023 (@ DeerHacks 2023)",
        imageURL: "img/slide-images/when2meet.jpg",
        imagePos: "top center",
        tagList: ["JavaScript", "CSS", "HTML"],
        background: "#b2ff91",
        interactionURL: "https://github.com/kleenkanteen/deerhacks-when2meet-improved/",
        content: [
            "A web application inspired by When2Meet, redesigned with a modern and user-friendly interface for scheduling meetings.",
            "Interactive timetable for users to select and compare meeting availability.",
        ],
    },
    {
        title: "placefox.xyz",

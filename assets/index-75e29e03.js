...
`)+`
`+u);const g=v+m+o,M=v+u+a,P=im(r,r.VERTEX_SHADER,g),R=im(r,r.FRAGMENT_SHADER,M);r.attachShader(x,P),r.attachShader(x,R),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function A(U){if(t.debug.checkShaderErrors){const I=r.getProgramInfoLog(x).trim(),b=r.getShaderInfoLog(P).trim(),Y=r.getShaderInfoLog(R).trim();let V=!0,$=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(V=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,P,R);else{const B=rm(r,P,"vertex"),C=rm(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
